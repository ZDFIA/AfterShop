...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <a href=" <?php echo e(url('item')); ?> " class="btn btn-primary"><i class="fas fa-arrow-left"></i> Kembali</a>
        </div>
...
unset($__errorArgs, $__bag); ?>" name="stock" required autocomplete="stock">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\toko\resources\views/admin/item/add.blade.php ENDPATH**/ ?>